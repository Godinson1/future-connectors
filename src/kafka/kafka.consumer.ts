...
export class KafkajsConsumer implements IConsumer {
  ...
  constructor(private readonly topic: ConsumerSubscribeTopics, private readonly dlqService: DlqService, config: ConsumerConfig, broker: string) {
